...
rad = st.sidebar.radio("Menu", ["Homepage", "History of currency", "History of currency with Candlesticks",
                                "Currency Price Prediction", "Custom", "About Us"])
if rad == 'Homepage':
    ...
    currency = st.selectbox("Which Currency do you want to predict", (
    'ADA-USD', 'AERGO-USD', 'AGLD-USD', 'ALGO-USD', 'ALI2-USD', 'ALICE-USD', 'ALPACA-USD', 'ALPINE-USD', 'AMP-USD',
    'AMPL-USD', 'ANY-USD', 'AQT-USD', 'AR-USD', 'ARDR-USD', 'ARPA-USD', 'ATA-USD', 'ATOM-USD', 'AURORA1-USD',
    'AVAX-USD', 'BAT-USD', 'BCD-USD', 'BCH-USD', 'BEST-USD', 'BIOT-USD', 'BNANA-USD', 'BNB-USD', 'BNX-USD', 'BOBA-USD',
    'BOR-USD', 'BOSON-USD', 'BRG-USD', 'BSW-USD', 'BTC-USD', 'BTCB-USD', 'BTCST-USD', 'BTS-USD', 'BUSD-USD', 'BZRX-USD',
    'BZZ-USD', 'C98-USD', 'CBK-USD', 'CELO-USD', 'CHR-USD', 'CHZ-USD', 'CLV-USD', 'COMP1-USD', 'CON-USD', 'CORE-USD',
    'COTI-USD', 'COVAL-USD', 'CQT-USD', 'CRE-USD', 'CRO-USD', 'CRV-USD', 'CTK-USD', 'CTSI-USD', 'CUBE-USD', 'CUDOS-USD',
    'CUSD-USD', 'CVX-USD', 'CVX-USD', 'DAD-USD', 'DAG-USD', 'DAI-USD', 'DAO-USD', 'DAR-USD', 'DASH-USD', 'DCR-USD',
    'DENT-USD', 'DIVI-USD', 'DNT-USD', 'DOGE-USD', 'DOT-USD', 'DPR-USD', 'DSV-USD', 'EFI-USD', 'EGG-USD', 'ELF-USD',
    'ENJ-USD', 'ENS-USD', 'EPS1-USD', 'ERN-USD', 'ETC-USD', 'ETH-USD', 'EUM-USD', 'FARM-USD', 'FET-USD', 'FIDA-USD',
    'FIL-USD', 'FLM-USD', 'FORTH-USD', 'FRTS-USD', 'FTT-USD', 'FX-USD', 'GALA-USD', 'GMT1-USD', 'GMT3-USD', 'GTC2-USD',
    'GUSD-USD', 'HBTC-USD', 'HERO1-USD', 'HEX-USD', 'HI-USD', 'HNS-USD', 'HT-USD', 'HUM-USD', 'HUNT-USD', 'HYDRA-USD',
    'ICP-USD', 'INJ-USD', 'IRIS-USD', 'JASMY-USD', 'JILL-USD', 'JOE-USD', 'KDA-USD', 'KMD-USD', 'KP3R-USD', 'KSN-USD',
    'LDO-USD', 'LEO-USD', 'LINK-USD', 'LOKA-USD', 'LOOM-USD', 'LRC-USD', 'LSK-USD', 'LTC-USD', 'LTO-USD', 'LUNA1-USD',
    'LYXE-USD', 'MANA-USD', 'MATIC-USD', 'MBOX-USD', 'MC-USD', 'MDX1-USD', 'MED-USD', 'METIS-USD', 'MFT-USD',
    'MINA-USD', 'MLK-USD', 'MNW-USD', 'MOB-USD', 'MOC-USD', 'MOVR-USD', 'MPL-USD', 'MTL-USD', 'MVIXY-USD', 'MVL-USD',
    'MX-USD', 'MXC-USD', 'NEAR-USD', 'NEO-USD', 'NEXO-USD', 'NOIA-USD', 'NU-USD', 'OGN-USD', 'OKB-USD', 'ONE1-USD',
    'ONG1-USD', 'ONUS-USD', 'ORBS-USD', 'ORC-USD', 'OSMO-USD', 'PCL-USD', 'PEAK-USD', 'PEOPLE-USD', 'PERP-USD',
    'PHA-USD', 'PLTC-USD', 'POWR-USD', 'PRE-USD', 'PUNDIX-USD', 'PYR-USD', 'QC-USD', 'QNT-USD', 'QUICK-USD', 'RAY-USD',
    'REQ-USD', 'RFR-USD', 'RGT-USD', 'RISE1-USD', 'ROOK-USD', 'RSR-USD', 'SDAO-USD', 'SE SFP-USD', 'SHIB-USD',
    'SLP-USD', 'SNT-USD', 'SOL-USD', 'SOUL-USD', 'SOV-USD', 'SPS-USD', 'STETH-USD', 'STMX-USD', 'SUPER1-USD',
    'SURE-USD', 'TAVA-USD', 'TITAN-USD', 'TKO-USD', 'TLM-USD', 'TLOS-USD', 'TRAC-USD', 'TRIBE-USD', 'TROY-USD',
    'TRX-USD', 'TUSD-USD', 'TVK-USD', 'UFO2-USD', 'UNI1-USD', 'UOS-USD', 'UPP-USD', 'UQC-USD', 'USDC-USD', 'USDN-USD',
    'USDP-USD', 'USDT-USD', 'USDX2-USD', 'UST-USD', 'VELO-USD', 'VERI-USD', 'VET-USD', 'VRA-USD', 'VRSC-USD',
    'VTHO-USD', 'VXV-USD', 'WAN-USD', 'WBTC-USD', 'WIN-USD', 'WNCG-USD', 'WOZX-USDLINA1-USD', 'WRFOX-USD', 'WRX-USD',
    'WTRX-USD', 'WWXT-USD', 'XAUT-USD', 'XCAD-USD', 'XCH-USD', 'XHV-USD', 'XLCX-USD', 'XLM-USD', 'XMR-USD', 'XNO-USD',
    'XPRT-USD', 'XRP-USD', 'XVG-USD', 'XYO-USD', 'YFII-USD', 'YGG-USD', 'ZB-USD'))
    ...
    for i in forecast.index:
        if (strdate == forecast['ds'][i]):
            st.write("## Currency Price on", forecast['ds'][i], "is", forecast['yhat'][i], "United States Dollar",
                     "and", forecast['yhat'][i] * 76.1, "in Indian Rupee")
        # j=0
...
"""
st.markdown(footer, unsafe_allow_html=True)%%writefile app.py
import streamlit as st
import pandas as pd
import yfinance as yf
from datetime import datetime
